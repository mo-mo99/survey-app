<template>
  <PageComponent title="Dashboard">
    ...
    >
      ...
      <div
      class="row-span-2 order-3 lg:order-1 bg-white animate-fade-in-down shadow-md p-4">
      ...
      <img 
        ...
        alt=""
      />
      <h3 class="text-xl font-bold mb-2">{{ data.latestSurvey.title }}</h3>
      ...
      <div
      class="bg-white shadow-md p-3 row-span-2 order-4 animate-fade-in-down lg:order-3"
